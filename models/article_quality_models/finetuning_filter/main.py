...
def fetch_class_labels(args):
    labels_file = os.path.join(os.path.abspath(args.dataset_path), 'dataset_final.txt')
...
if __name__ == "__main__":
    ...
    args.logger_exp_name = "title-partial-%s" % args.model_name
    ...
    logger_args = {
        'project': 'wikimedia-ml',    # first create a project on weight & bias with local account
